...
class AMEXPlugin extends BasePlugin {
  ...
  async scrapeTransactions() {
    ...
    await this.page.goto('https://global.americanexpress.com/myca/logon/canlac/action/LogonHandler?request_type=LogonHandler&Face=en_CA&inav=ca_utility_login', {waitUntil: 'networkidle0'});
    ...
    await this.page.goto('https://global.americanexpress.com/myca/intl/istatement/canlac/statement.do?Face=en_CA&method=displayStatement', {waitUntil: 'networkidle0'});
