...
class ChaseCanadaPlugin extends BasePlugin {
  ...
  async scrapeTransactions() {
    ...
    // Click "Sign On"
    await this.pageClick('body > table > tbody > tr > td > table:nth-child(1) > tbody > tr > td:nth-child(1) > table > tbody > tr:nth-child(10) > td > table > tbody > tr:nth-child(4) > td > input[type="submit"]');
