...
class ChaseCanadaPlugin extends BasePlugin {
  constructor(browser, logger, pluginArgs) {
    ...
    if (!this.pluginArgs.securityAnswer) {
      ...
      this.pluginArgs.securityAnswer = process.env.CHASECANADA_PLUGIN_SECURITYANSWER;
    }
